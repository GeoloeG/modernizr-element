/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-ambientlight-appearance-applicationcache-audio-backdropfilter-backgroundblendmode-backgroundcliptext-backgroundsize-batteryapi-bgpositionshorthand-bgpositionxy-bgrepeatspace_bgrepeatround-bgsizecover-blobconstructor-borderimage-borderradius-boxshadow-boxsizing-canvas-canvastext-checked-contenteditable-contextmenu-cookies-cors-cryptography-cssanimations-csscalc-csschunit-csscolumns-customevent-customprotocolhandler-dart-dataview-emoji-eventlistener-exiforientation-flash-forcetouch-fullscreen-gamepads-geolocation-hashchange-hiddenscroll-history-htmlimports-ie8compat-indexeddb-indexeddbblob-input-inputtypes-intl-json-ligatures-mathml-notification-olreversed-pagevisibility-performance-pointerevents-pointerlock-postmessage-proximity-queryselector-quotamanagement-requestanimationframe-search-serviceworker-svg-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-printshiv-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
